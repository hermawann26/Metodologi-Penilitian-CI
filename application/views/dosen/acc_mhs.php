...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Mahasiswa Calon Bimbingan
        <small></small>
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <?php foreach ($data->result_array() as $i) :                    
                ...
                <tr>
                  ...
                  <td>       <form method="post" action="<?php echo base_url().'dosen/acc/terima'?>">
                     <input type="hidden" name="kode" value="<?php echo $nim;?>">
                      <input type="hidden" name="xnim" value="<?php echo $nim;?>">
                      <input type="hidden" name="xnama" value="<?php echo $nama;?>">
                      <input type="hidden" name="xjudul" value="<?php echo $judul;?>">
                        <input type="submit" name="submit" value="Terima" class="btn btn-primary btn-sm" style="color: white" ></form>
                        <form method="post" action="<?php echo base_url().'dosen/acc/tolak'?>">
                      <input type="hidden" name="kode" value="<?php echo $nim;?>">
