...
<body>
  ...
  <div class="container">
    ...
    <div class="col-md-12">
          ...
          <div class="card my-4">
          <h5 class="card-header">Upload File UTS</h5>
          <div class="card-body">
            
          
    <form action="<?php echo base_url().'mhs/uploaduts/updateuts' ?>"  method="post" enctype="multipart/form-data">
      <div class="form-group">
        <label >NIM</label>
        <input type="text" class="form-control" name="xnim"  >
      </div>
       <div class="form-group">
        <input type="file" name="xuts"  >
      </div>
